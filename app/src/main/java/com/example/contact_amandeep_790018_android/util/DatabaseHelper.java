package com.example.contact_amandeep_790018_android.util;
...
public class DatabaseHelper extends SQLiteOpenHelper {
     ...
     * */
    public boolean addEmployee(String fname, String lname, String email, double phno, String address) {
        ...
        contentValues.put(COLUMN_PH_NO, String.valueOf(phno));
     ...
     * */
    public boolean updateEmployee(int id, String fname, String lname, String email, double phno, String address) {
